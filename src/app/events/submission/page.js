        ...
        <>
            <div className='w-screen h-screen absolute top-0 left-0 flex justify-center items-center'>
                <div className='flex flex-col justify-center items-center gap-4 w-max'>
                    ...
                    <a target="_blank" href="https://forms.gle/HjP1xd37yFsNZANy8" className='text-3xl text-center bg-[rgba(255,255,255,0.08)] hover:bg-[rgba(255,255,255,0.18)] transition w-full px-7 py-1 rounded-md' data-cursor-color="#fff">Pixelate Sr.</a>
                </div>
            </div>
