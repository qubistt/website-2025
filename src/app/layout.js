...
import { SiFacebook, SiInstagram, SiYoutube, SiDiscord } from "react-icons/si"
...
export const metadata = {
    title: 'Digex Clan',
    description: 'Digexclan : The premier photography and film-making club at Delhi Public School R.K. Puram.',
}
                ...
                <main className="max-w-full w-[100vw] overflow-x-hidden flex flex-col items-center justify-center font-montserrat">
                    ...
                    <div className='z-10 max-w-full w-screen flex flex-col lg:flex-row justify-between items-center gap-3 py-4 sm:gap-5 lg:gap-0 lg:py-7 lg:px-24 mt-[200px] bgDot'>
                        <div className='flex justify-start flex-1 gap-7'>
                            <Link href="/facebook" className='text-2xl' data-cursor-color="#1877F2"><SiFacebook /></Link>
                            <Link href="/instagram" className='text-2xl' data-cursor-color="#d62976"><SiInstagram /></Link>
                            <Link href="/youtube" className='text-2xl' data-cursor-color="#ff0000"><SiYoutube /></Link>
                            <Link href="/25/discord" className='text-2xl' data-cursor-color="#7289DA"><SiDiscord /></Link>
                        </div>
