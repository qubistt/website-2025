...
const Cursor = () => {
    ...
    useEffect(() => {
        ...
        document.addEventListener("DOMSubtreeModified", mainFunc)

        return () => {
            document.removeEventListener('DOMSubtreeModified', mainFunc);
    ...
    return (
        visible
            ? <>
                ...
                <div
                    className={`z-[100] w-14 h-14 fixed top-0 left-0 rounded-full pointer-events-none transition duration-150 ease-linear -translate-x-1/2 -translate-y-1/2 border border-white`}
